...
var loaded = false; // true if javascript has loaded
var currGame; // current game instance
...
function startGame(){
	...
	currGame = new GrineerHacker();
	currGame.StartGame(cx, 1, 3, true);
	//console.log("game ended with result [" + currGame.stats.won + "]");
}
...
function GrineerHacker(){
	...
	this.StartGame = function(ctx, numWedges, startSpd, constRot){ // starts game instance
